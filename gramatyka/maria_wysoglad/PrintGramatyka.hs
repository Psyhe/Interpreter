...
instance Print AbsGramatyka.Program where
  prt i = \case
    AbsGramatyka.ProgramName alldefs -> prPrec i 0 (concatD [prt 0 alldefs])

instance Print [AbsGramatyka.AllDef] where
  prt _ [] = concatD []
...
instance Print AbsGramatyka.Arg where
  prt i = \case
    AbsGramatyka.ValArg type_ id_ -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_])
    AbsGramatyka.VarArg type_ id_ -> prPrec i 0 (concatD [doc (showString "var"), prt 0 type_, prt 0 id_])
...
instance Print AbsGramatyka.AllDef where
  prt i = \case
    AbsGramatyka.FunDef type_ id_ args block -> prPrec i 0 (concatD [doc (showString "def"), prt 0 type_, prt 0 id_, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
    AbsGramatyka.VarDef type_ id_ expr -> prPrec i 0 (concatD [doc (showString "var"), prt 0 type_, prt 0 id_, doc (showString "="), prt 0 expr, doc (showString ";")])

instance Print AbsGramatyka.Block where
  prt i = \case
    AbsGramatyka.BlockName stmts -> prPrec i 0 (concatD [doc (showString "{"), prt 0 stmts, doc (showString "}")])
...
instance Print AbsGramatyka.Stmt where
  prt i = \case
    ...
    AbsGramatyka.DefStmt alldef -> prPrec i 0 (concatD [prt 0 alldef])
    AbsGramatyka.Ass id_ expr -> prPrec i 0 (concatD [prt 0 id_, doc (showString "="), prt 0 expr, doc (showString ";")])
    AbsGramatyka.Incr id_ -> prPrec i 0 (concatD [prt 0 id_, doc (showString "++"), doc (showString ";")])
    AbsGramatyka.Decr id_ -> prPrec i 0 (concatD [prt 0 id_, doc (showString "--"), doc (showString ";")])
    ...
    AbsGramatyka.Cond expr block -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block])
    AbsGramatyka.CondElse expr block1 block2 -> prPrec i 0 (concatD [doc (showString "if"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block1, doc (showString "else"), prt 0 block2])
    AbsGramatyka.While expr block -> prPrec i 0 (concatD [doc (showString "while"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block])
    AbsGramatyka.Break -> prPrec i 0 (concatD [doc (showString "break"), doc (showString ";")])
    AbsGramatyka.Cont -> prPrec i 0 (concatD [doc (showString "continue"), doc (showString ";")])
...
instance Print AbsGramatyka.Type where
  prt i = \case
    ...
    AbsGramatyka.Void -> prPrec i 0 (concatD [doc (showString "void")])
    AbsGramatyka.Fun types type_ -> prPrec i 0 (concatD [doc (showString "("), prt 0 types, doc (showString ")"), doc (showString "->"), prt 0 type_])
...
instance Print AbsGramatyka.Expr where
  prt i = \case
    ...
    AbsGramatyka.ELambda args type_ block -> prPrec i 0 (concatD [doc (showString "lambda"), doc (showString "("), prt 0 args, doc (showString ")"), doc (showString "->"), prt 0 type_, prt 0 block])
