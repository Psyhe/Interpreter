...
-- | The abstract syntax of language wyso.

module AbsWyso where
...
data Program' a = ProgramName a [AllDef' a]
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type Arg = Arg' BNFC'Position
data Arg' a = ValArg a (Type' a) Ident | VarArg a (Type' a) Ident
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type AllDef = AllDef' BNFC'Position
data AllDef' a
    = FunDef a (Type' a) Ident [Arg' a] (Block' a)
    | VarDef a (Type' a) Ident (Expr' a)
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)

type Block = Block' BNFC'Position
data Block' a = BlockName a [Stmt' a]
  deriving (C.Eq, C.Ord, C.Show, C.Read, C.Functor, C.Foldable, C.Traversable)
...
instance HasPosition AllDef where
  hasPosition = \case
    FunDef p _ _ _ _ -> p
    VarDef p _ _ _ -> p
